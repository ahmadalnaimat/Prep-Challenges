...
const replaceWords = (str) => {
    ...
    let index = words.indexOf("I");
    if (index !== -1) {
        words.splice(index, 1, "We");
    }

    index = words.indexOf("am");
    if (index !== -1) {
        words.splice(index, 1, "are");
    }

    index = words.indexOf("was");
    if (index !== -1) {
        words.splice(index, 1, "were");
    }
