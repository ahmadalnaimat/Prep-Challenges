...
const cvFormatter = (arr) => {
    return arr
        .filter(applicant => applicant.yearsOfExperience > 1) 
        .map(applicant => { 
            let fullName = applicant.firstName;
...
const applicationsStatics = (arr) => {
    ...
    arr.forEach(applicant => {
        ...
        if (!applicant.fullName && !applicant.lastName || applicant.yearsOfExperience < 1) {
...
const classesAvg = (data) => {
    data.grades.forEach(grade => {
        grade.classes.forEach(singleClass => {
            let totalScore = singleClass.classScores.reduce((sum, score) => sum + score, 0);
            let averageScore = Math.floor(totalScore / singleClass.classScores.length);
            singleClass.avg = averageScore;
        });
    });
    return data;};
// -------------------------------------------------------------------------------------------------------
