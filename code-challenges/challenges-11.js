...
function fullName(arr) {
    // write your code here
    let fName = arr.map(name => `${name.firstName} ${name.lastName}`)
    return fName;
}
// -------------------------------------------------------------------------------------------------------
...
function gradesAvg(arr) {
    ...
    return arr.map(student=> {
        let sum = student.gradsList.reduce((acc,grade) => acc + grade ,0);
        let avg = sum / student.gradsList.length;
        return {...student,avg};
    })
}
// -------------------------------------------------------------------------------------------------------
